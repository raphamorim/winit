...
impl Window {
    ...
    pub fn id(&self) -> WindowId {
        let _span = tracing::debug_span!("rio_winit_fork::Window::id",).entered();
    ...
    pub fn scale_factor(&self) -> f64 {
        let _span = tracing::debug_span!("rio_winit_fork::Window::scale_factor",).entered();
    ...
    pub fn request_redraw(&self) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::request_redraw",).entered();
    ...
    pub fn pre_present_notify(&self) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::pre_present_notify",).entered();
    ...
    pub fn reset_dead_keys(&self) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::reset_dead_keys",).entered();
...
impl Window {
    ...
    pub fn inner_position(&self) -> Result<PhysicalPosition<i32>, NotSupportedError> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::inner_position",).entered();
    ...
    pub fn outer_position(&self) -> Result<PhysicalPosition<i32>, NotSupportedError> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::outer_position",).entered();
    ...
    ///
    /// ```no_run
    /// # use rio_winit_fork::dpi::{LogicalPosition, PhysicalPosition};
    /// # use rio_winit_fork::window::Window;
    /// # fn scope(window: &Window) {
    ...
    pub fn set_outer_position<P: Into<Position>>(&self, position: P) {
        ...
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_outer_position",
            position = ?position
        )
        .entered();
    ...
    pub fn inner_size(&self) -> PhysicalSize<u32> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::inner_size",).entered();
    ...
    ///
    /// ```no_run
    /// # use rio_winit_fork::dpi::{LogicalSize, PhysicalSize};
    /// # use rio_winit_fork::window::Window;
    /// # fn scope(window: &Window) {
    ...
    pub fn request_inner_size<S: Into<Size>>(&self, size: S) -> Option<PhysicalSize<u32>> {
        let size = size.into();
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::request_inner_size",
            size = ?size
        )
        .entered();
    ...
    pub fn outer_size(&self) -> PhysicalSize<u32> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::outer_size",).entered();
    ...
    pub fn set_min_inner_size<S: Into<Size>>(&self, min_size: Option<S>) {
        ...
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_min_inner_size",
            min_size = ?min_size
        )
        .entered();
    ...
    pub fn set_max_inner_size<S: Into<Size>>(&self, max_size: Option<S>) {
        ...
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::max_size",
            max_size = ?max_size
        )
        .entered();
    ...
    pub fn resize_increments(&self) -> Option<PhysicalSize<u32>> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::resize_increments",).entered();
    ...
    pub fn set_resize_increments<S: Into<Size>>(&self, increments: Option<S>) {
        ...
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_resize_increments",
...
impl Window {
    ...
    pub fn set_title(&self, title: &str) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_title", title).entered();
    ...
    pub fn set_transparent(&self, transparent: bool) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_transparent", transparent).entered();
    ...
    pub fn set_blur(&self, blur: bool) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_blur", blur).entered();
    ...
    pub fn set_visible(&self, visible: bool) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_visible", visible).entered();
    ...
    pub fn is_visible(&self) -> Option<bool> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::is_visible",).entered();
    ...
    pub fn set_resizable(&self, resizable: bool) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_resizable", resizable).entered();
    ...
    pub fn is_resizable(&self) -> bool {
        let _span = tracing::debug_span!("rio_winit_fork::Window::is_resizable",).entered();
    ...
    pub fn set_enabled_buttons(&self, buttons: WindowButtons) {
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_enabled_buttons",
            buttons = ?buttons
        )
        .entered();
    ...
    pub fn enabled_buttons(&self) -> WindowButtons {
        let _span = tracing::debug_span!("rio_winit_fork::Window::enabled_buttons",).entered();
    ...
    pub fn set_minimized(&self, minimized: bool) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_minimized", minimized).entered();
    ...
    pub fn is_minimized(&self) -> Option<bool> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::is_minimized",).entered();
    ...
    pub fn set_maximized(&self, maximized: bool) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_maximized", maximized).entered();
    ...
    pub fn is_maximized(&self) -> bool {
        let _span = tracing::debug_span!("rio_winit_fork::Window::is_maximized",).entered();
    ...
    pub fn set_fullscreen(&self, fullscreen: Option<Fullscreen>) {
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_fullscreen",
    ...
    pub fn fullscreen(&self) -> Option<Fullscreen> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::fullscreen",).entered();
    ...
    pub fn set_decorations(&self, decorations: bool) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_decorations", decorations).entered();
    ...
    pub fn is_decorated(&self) -> bool {
        let _span = tracing::debug_span!("rio_winit_fork::Window::is_decorated",).entered();
    ...
    pub fn set_window_level(&self, level: WindowLevel) {
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_window_level",
            level = ?level
        )
        .entered();
    ...
    pub fn set_window_icon(&self, window_icon: Option<Icon>) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_window_icon",).entered();
    ...
    ///
    /// ```no_run
    /// # use rio_winit_fork::dpi::{LogicalPosition, PhysicalPosition, LogicalSize, PhysicalSize};
    /// # use rio_winit_fork::window::Window;
    /// # fn scope(window: &Window) {
    /// // Specify the position in logical dimensions like this:
    ...
    pub fn set_ime_cursor_area<P: Into<Position>, S: Into<Size>>(&self, position: P, size: S) {
        ...
        let size = size.into();
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_ime_cursor_area",
            position = ?position,
            size = ?size,
        )
        .entered();
    ...
    pub fn set_ime_allowed(&self, allowed: bool) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_ime_allowed", allowed).entered();
    ...
    pub fn set_ime_purpose(&self, purpose: ImePurpose) {
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_ime_purpose",
            purpose = ?purpose
        )
        .entered();
    ...
    pub fn focus_window(&self) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::focus_window",).entered();
    ...
    pub fn has_focus(&self) -> bool {
        let _span = tracing::debug_span!("rio_winit_fork::Window::has_focus",).entered();
    ...
    pub fn request_user_attention(&self, request_type: Option<UserAttentionType>) {
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::request_user_attention",
    ...
    pub fn set_theme(&self, theme: Option<Theme>) {
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_theme",
            theme = ?theme
        )
        .entered();
    ...
    pub fn theme(&self) -> Option<Theme> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::theme",).entered();
    ...
    pub fn set_content_protected(&self, protected: bool) {
        let _span =
            tracing::debug_span!("rio_winit_fork::Window::set_content_protected", protected).entered();
    ...
    pub fn title(&self) -> String {
        let _span = tracing::debug_span!("rio_winit_fork::Window::title",).entered();
...
impl Window {
    ...
    pub fn set_cursor(&self, cursor: impl Into<Cursor>) {
        ...
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_cursor",).entered();
    ...
    pub fn set_cursor_position<P: Into<Position>>(&self, position: P) -> Result<(), ExternalError> {
        let position = position.into();
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_cursor_position",
            position = ?position
        )
        .entered();
    ...
    ///
    /// ```no_run
    /// # use rio_winit_fork::window::{CursorGrabMode, Window};
    /// # fn scope(window: &Window) {
    /// window
    ...
    pub fn set_cursor_grab(&self, mode: CursorGrabMode) -> Result<(), ExternalError> {
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::set_cursor_grab",
            mode = ?mode
        )
        .entered();
    ...
    pub fn set_cursor_visible(&self, visible: bool) {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_cursor_visible", visible).entered();
    ...
    pub fn drag_window(&self) -> Result<(), ExternalError> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::drag_window",).entered();
    ...
    pub fn drag_resize_window(&self, direction: ResizeDirection) -> Result<(), ExternalError> {
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::drag_resize_window",
            direction = ?direction
        )
        .entered();
    ...
    pub fn show_window_menu(&self, position: impl Into<Position>) {
        let position = position.into();
        let _span = tracing::debug_span!(
            "rio_winit_fork::Window::show_window_menu",
            position = ?position
        )
        .entered();
    ...
    pub fn set_cursor_hittest(&self, hittest: bool) -> Result<(), ExternalError> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::set_cursor_hittest", hittest).entered();
...
impl Window {
    ...
    pub fn current_monitor(&self) -> Option<MonitorHandle> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::current_monitor",).entered();
    ...
    pub fn available_monitors(&self) -> impl Iterator<Item = MonitorHandle> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::available_monitors",).entered();
        self.window.maybe_wait_on_main(|w| {
    ...
    pub fn primary_monitor(&self) -> Option<MonitorHandle> {
        let _span = tracing::debug_span!("rio_winit_fork::Window::primary_monitor",).entered();
